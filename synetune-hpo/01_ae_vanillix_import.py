...
BLACKBOX_NAME = "autoencodix_vanillix" # create one blackbox per AE architecture, as it has its hyperparameter set
...
class AutoEncodixVanillixBlackboxRecipe(BlackboxRecipe):
    def __init__(self):
        super(AutoEncodixVanillixBlackboxRecipe, self).__init__(
            name=BLACKBOX_NAME,
            cite_reference="Vanillix AE from 'A generalized and versatile framework to train and evaluate autoencoders for biological representation learning and beyond: AUTOENCODIX',"
    ...
    def _generate_on_disk(self):
        ...
        with catchtime("loading data"):
            ...
            df_dict = {
                ('tcga','rna')  : pd.read_parquet("../autoencodix-hpo/real_ae_results_vanillix_tcga_RNA.parquet"),
                ('tcga','meth') : pd.read_parquet("../autoencodix-hpo/real_ae_results_vanillix_tcga_METH.parquet"),
                ('tcga', 'dna') : pd.read_parquet("../autoencodix-hpo/real_ae_results_vanillix_tcga_DNA.parquet"),
                ('schc', 'rna') : pd.read_parquet("../autoencodix-hpo/real_ae_results_vanillix_schc_RNA.parquet"),
                ('schc', 'meth'): pd.read_parquet("../autoencodix-hpo/real_ae_results_vanillix_schc_METH.parquet"),
            }
...
if __name__ == "__main__":
    AutoEncodixVanillixBlackboxRecipe().generate(upload_on_hub=False)
